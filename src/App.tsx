          ...
          {activeSection === 'hero' && (
            ...
            >
              <div className="section-content-wrapper">
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', alignItems: 'center', gap: '4rem' }}>
                  <div style={{ zIndex: 1 }}>
                    <div className="hero-tag">OPEN FOR COLLABORATION</div>
                    <h1 style={{ fontSize: 'clamp(3rem, 7vw, 6rem)', lineHeight: 0.9, marginBottom: '2.5rem' }}>
                      Ahadun<br /><span style={{ color: 'var(--accent)' }}>Nobi</span>
                    </h1>
                    <p style={{ fontSize: '1.2rem', color: 'var(--muted)', lineHeight: 1.7, maxWidth: '540px', marginBottom: '3rem', fontWeight: '500' }}>
                    ...
                    <div style={{ display: 'flex', gap: '3rem', marginBottom: '3.5rem' }}>
 ...
 className="btn-ghost">VIEW PROJECTS</button>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'center', position: 'relative' }}>
                    <div style={{ position: 'relative', width: '320px', height: '420px' }}>
                      ...
                      />
                      <div style={{ position: 'absolute', bottom: '-20px', right: '-20px', width: '100%', height: '100%', border: '1px solid var(--accent)', opacity: 0.3, pointerEvents: 'none', zIndex: -1 }}></div>
                      <div style={{ position: 'absolute', bottom: '20px', left: '-30px', background: 'var(--accent)', color: '#0a0a0a', fontFamily: 'var(--font-mono)', fontSize: '0.8rem', fontWeight: 800, letterSpacing: '0.25em', padding: '0.6rem 1.2rem' }}>
                        FULL-STACK ENGINEER
                      </div>
                    </div>
                  </div>
